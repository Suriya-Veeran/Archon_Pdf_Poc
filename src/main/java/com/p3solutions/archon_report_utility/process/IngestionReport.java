...
public class IngestionReport extends ReportUtils {
  ...
  public void generateReport() throws IOException {
    ...
    dataInfoBeanList.add(buildDataInfoBean("Success", 6, FormatTypes.MB, "#4169E1"));
    dataInfoBeanList.add(buildDataInfoBean("Failed", 1, FormatTypes.MB, "#FF0000"));
    ...
    filesDataInfoBeanList.add(buildDataInfoBean("Success", 6, FormatTypes.MB, "#4169E1"));
